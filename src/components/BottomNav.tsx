...
export default function BottomNav({active,onChange}:{active:AppSection;onChange:(s:AppSection)=>void}) {
 const items=[{key:"explore" as const,label:"Explore",icon:IconMap2},{key:"surprise" as const,label:"Surprise me",icon:IconSparkles},{key:"account" as const,label:"Account",icon:IconUserCircle}];
