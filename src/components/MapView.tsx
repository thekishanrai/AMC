...
export default function MapView({ initialSpot = null }: { initialSpot?: Spot | null }) {
  ...
  const[drawerState,setDrawerState]=useState<"min"|"half"|"full">("half");const drawerStartY=useRef<number|null>(null),drawerStartHeight=useRef(0),drawerStartTime=useRef(0),drawerLastY=useRef(0),drawerLastTime=useRef(0),drawerMoved=useRef(false);
