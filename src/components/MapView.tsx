...
export default function MapView({ initialSpot = null, initialSpots = [] }: { initialSpot?: Spot | null; initialSpots?: Spot[] }) {
  ...
  // Drawer drag writes its height at most once per frame (touch fires up to 120Hz).
  const drawerFrame = useRef(0), drawerTargetH = useRef(0);
