...
const config: UtilityFormConfig = {number:"04",title:"CONTACT US",intro:"A straight line to the club for partnerships, press, questions and everything else.",submitLabel:"SEND MESSAGE ↗",fields:[
